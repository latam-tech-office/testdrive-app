...
/**
 * It creates a connection straight to MongoDB Database
 * 
...
public class MongoProvider {
    ...
    public static final String DEFAULT_DB_USERNAME="testdrive";
    public static final String DEFAULT_DB_PASSWORD="r3dh4t1!";
    public static final String DEFAULT_DB_DATABASE="testdrive";
